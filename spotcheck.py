	...
	def serial_handle(self):
		...
		if(bled_ready):
			...
			if(SC_VERSION != 48):
				...
				sheet.merge_cells(start_row=77, start_column=5, end_row=77, end_column=7)
				sheet.merge_cells(start_row=78, start_column=5, end_row=78, end_column=7)
				sheet['B77'] = Screening3_Language["Result TechnicianNameSign Text"][language]
				sheet['B78'] = ''
				sheet['E77'] = Screening3_Language["Result HeadOfDivisionSign Text"][language]
				sheet['E78'] = ''
				sheet["B77"].font = font2
				sheet["E77"].font = font2
				sheet["B77"].protection = Protection(locked=False, hidden=False)
				sheet["E77"].protection = Protection(locked=False, hidden=False)
				sheet.cell(row=77,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=78,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=77,column=5).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=78,column=5).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)

				sheet.merge_cells(start_row=67, start_column=2, end_row=67, end_column=3)
				sheet.row_dimensions[67].height = 40
				sheet['B67'] = Screening3_Language["Result NoteTable Text"][language]
				sheet["B67"].font = font2
				sheet["B68"].font = font2
				sheet["C68"].font = font2
				sheet["B74"].font = font2
				sheet.cell(row=67,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=67,column=2).border = thin_border
				sheet.cell(row=67,column=3).border = thin_border
				sheet.cell(row=68,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=68,column=2).border = thin_border
				sheet.cell(row=69,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=69,column=2).border = thin_border
				sheet.cell(row=70,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=70,column=2).border = thin_border
				sheet.cell(row=71,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=71,column=2).border = thin_border
				sheet.cell(row=72,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=72,column=2).border = thin_border
				sheet.cell(row=68,column=3).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=68,column=3).border = thin_border
				sheet.cell(row=69,column=3).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=69,column=3).border = thin_border
				sheet.cell(row=70,column=3).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=70,column=3).border = thin_border
				sheet.cell(row=71,column=3).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=71,column=3).border = thin_border
				sheet.cell(row=72,column=3).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=72,column=3).border = thin_border
				sheet['B68'] = 'Spotcheck'
				sheet['C68'] = 'CT'
				sheet['B69'] = 'X ≤ ' + str(self.base_window.main_menu.num1)
				sheet['C69'] = '-'
				sheet['B70'] = str(self.base_window.main_menu.num1) + ' < X ≤ ' + str(self.base_window.main_menu.num2)
				sheet['C70'] = '31-35'
				sheet['B71'] = str(self.base_window.main_menu.num2) + ' < X ≤ ' + str(self.base_window.main_menu.num3)
				sheet['C71'] = '26-30'
				sheet['B72'] = 'X > ' + str(self.base_window.main_menu.num3)
				sheet['C72'] = '< 26'

				sheet['B74'] = Screening3_Language["Result NoteLabel Text"][language]
				sheet.merge_cells(start_row=75, start_column=2, end_row=75, end_column=6)
				sheet['B75'] = Screening3_Language["Result NoteContent Text"][language]
				...
				for i in range(0, WELL_ROW):
					...
					if(SC_VERSION == 48):
						...
						if(self.base_window.qualitative_analysis_2.id_list[c5]=='N/A'):
							...
							sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*4)] = 'N/A'
						else:
							if(float(self.result_label[c5]['text']) <= self.base_window.main_menu.num1):
							...
							elif(float(self.result_label[c5]['text']) <= self.base_window.main_menu.num2):
								sheet['D'+str(i + RESULT_CELL_START + WELL_ROW*4)] = self.result_label[c5]['text']
								...
								sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*4)] = '31-35'
								sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*4)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
								sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*4)].font = font2
								...
								sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*4)] = '26-30'
						...
						if(self.base_window.qualitative_analysis_2.id_list[c6]=='N/A'):
							...
							sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*5)] = 'N/A'
						else:
							if(self.result_label[c6]['text'] != 'B'):
								if(float(self.result_label[c6]['text']) <= self.base_window.main_menu.num1):
								...
								elif(float(self.result_label[c6]['text']) <= self.base_window.main_menu.num2):
									sheet['D'+str(i + RESULT_CELL_START + WELL_ROW*5)] = self.result_label[c6]['text']
									...
									sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*5)] = '31-35'
									sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*5)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
									sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*5)].font = font2
									...
									sheet['E'+str(i + RESULT_CELL_START + WELL_ROW*5)] = '26-30'
	...
	def save_clicked(self):
		...
		if path is not None:
			...
			if(SC_VERSION != 48):
				...
				sheet.merge_cells(start_row=77, start_column=4, end_row=77, end_column=6)
				sheet.merge_cells(start_row=78, start_column=4, end_row=78, end_column=6)
				sheet['B77'] = Screening3_Language["Result TechnicianNameSign Text"][language]
				sheet['B78'] = ''
				sheet['D77'] = Screening3_Language["Result HeadOfDivisionSign Text"][language]
				sheet['D78'] = ''
				sheet["B77"].font = font2
				sheet["D77"].font = font2
				sheet["B77"].protection = Protection(locked=False, hidden=False)
				sheet["D77"].protection = Protection(locked=False, hidden=False)
				sheet.cell(row=77,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=78,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=77,column=4).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
				sheet.cell(row=78,column=4).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
	...
	def serial_handle(self):
		...
		if(bled_ready):
			...
			if(SC_VERSION != 48):
				...
				sheet.merge_cells(start_row=77, start_column=4, end_row=77, end_column=6)
				sheet.merge_cells(start_row=78, start_column=4, end_row=78, end_column=6)
				sheet['B77'] = Quantitative3_Language["Result TechnicianNameSign Text"][language]
				sheet['B78'] = ''
				sheet['D77'] = Quantitative3_Language["Result HeadOfDivisionSign Text"][language]
				sheet['D78'] = ''
				sheet["B77"].font = font2
				sheet["D77"].font = font2
				sheet["B77"].protection = Protection(locked=False, hidden=False)
